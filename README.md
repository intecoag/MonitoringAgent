...
2. .env.template zu .env kopieren und anpassen
3. Aufstarten mit update.sh
4. Im Crontab update.sh einmal täglich ausführen lassen: aktualisiert das Image und das Repo
